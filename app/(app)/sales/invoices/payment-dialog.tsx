...
export function PaymentDialog({
  ...
  invoice: { id: string; number: string; outstanding: number };
}) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Invoice {invoice.number} · Outstanding {formatCurrency(invoice.outstanding)}
          </DialogDescription>
        </DialogHeader>
        <form action={action} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                defaultValue={invoice.outstanding} required
              />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="reference" name="reference" placeholder="Cheque no. / M-Pesa code" />
          </div>
